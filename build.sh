...
#################################################################
curl https://raw.githubusercontent.com/opengovsg/isomer-build/ga-test/overrides/netlify.toml -o /opt/build/repo/netlify.toml

###################################################################
# Obtain config override file to enforce plugins and remote theme #
###################################################################
curl https://raw.githubusercontent.com/opengovsg/isomer-build/ga-test/overrides/_config-override.yml -o /opt/build/repo/_config-override.yml
...
# or github-pages                                #
##################################################
curl https://raw.githubusercontent.com/opengovsg/isomer-build/ga-test/overrides/Gemfile-github-pages -o /opt/build/repo/Gemfile-github-pages
curl https://raw.githubusercontent.com/opengovsg/isomer-build/ga-test/overrides/Gemfile-isomer-jekyll -o /opt/build/repo/Gemfile-isomer-jekyll
