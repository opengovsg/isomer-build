...
#####################################################################
curl https://raw.githubusercontent.com/opengovsg/isomer-build/kishore-test-dev/overrides/customHttp.yml -o customHttp.yml


###################################################################
# Obtain config override file to enforce plugins and remote theme #
###################################################################
curl https://raw.githubusercontent.com/opengovsg/isomer-build/kishore-test-dev/overrides/_config-override.yml -o _config-override.yml
...
bundle exec jekyll serve --config _config.yml",$var",_config-override.yml -I
